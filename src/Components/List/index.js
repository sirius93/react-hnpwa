    ...
    const RenderList = ListData ? ListData.map((news) =>
        <div className="News-list">
            ...
            <div className="News-content">
                ...
                <div className="News-details">By <a href="#" alt={news.user}>{news.user}</a> | <span className="time-ago">{news.time_ago}</span></div>
                <div className="comments"><a href="#" alt={news.comments_count}>{news.comments_count} Comments</a></div>
            </div>
        </div>
        ):''
    return (
